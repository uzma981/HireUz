  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center w-full px-7 md:justify-center ">
        <button className="mt-5 bg-purple-700 rounded hover:bg-purple-600 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white lg:max-w-[144px] w-full md:text-lg">
          Submit
        </button>
      </div>
    </div>
